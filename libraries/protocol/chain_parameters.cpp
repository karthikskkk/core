...
namespace graphene { namespace protocol {
   ...
   void chain_parameters::safe_copy(chain_parameters& to, const chain_parameters& from)
   {
      ...
      to.dxpcore_proposal_review_period = from.dxpcore_proposal_review_period;
      ...
      to.maximum_blockproducer_count = from.maximum_blockproducer_count;
      to.maximum_dxpcore_count = from.maximum_dxpcore_count;
      ...
      to.blockproducer_pay_per_block = from.blockproducer_pay_per_block;
      to.blockproducer_pay_vesting_seconds = from.blockproducer_pay_vesting_seconds;
      to.benefactor_budget_per_day = from.benefactor_budget_per_day;
   ...
   void chain_parameters::validate()const
   {
      ...
      FC_ASSERT( maximum_proposal_lifetime - dxpcore_proposal_review_period > block_interval,
                 "Dxpcore proposal review period must be less than the maximum proposal lifetime" );
