---
name: Bug Report
about: Create a detailed report about a deficiency in the Dxperts Core implementation.
...
**Impacts**
Describe which portion(s) of Dxperts Core may be impacted by this bug. Please tick at least one box.
...
**Host Environment**
Please provide details about the host environment. Much of this information can be found running: `blockproducer_node --version`. 
 - Host OS:             [e.g. Ubuntu 18.04 LTS]
 - Host Physical RAM    [e.g. 4GB]
 - Dxperts Version:   [e.g. 2.0.180425]
