Lets face it, in this days most of the dxperts accounts are created through OpenLedger.
...
```
root@NC-PH-1346-07:~/dxperts/issue163/dxperts-core# ./programs/cli_wallet/cli_wallet --server-rpc-endpoint ws://localhost:8090
```
