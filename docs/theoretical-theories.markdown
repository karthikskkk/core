...
In SmartTokens 3.0, shorts should be allowed to specify a flag indicating whether they want to stay in (as much as possible) or whether they want to stay out. If a short wants in, on redemption they will be partially covered; if a short wants out, they will be fractionally covered.
...
- Privatized SmartTokens : Separate feed providers from asset owners
...
Arhag mentions graduated margin call premium here:

- Market matching of redemption requests

Despite my rebuttal of arhag here:
