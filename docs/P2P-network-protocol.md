...
Upon receiving one, a node immediately sends back a [current_time_reply_message](https://gitlab.com/dxperts/dxperts-core/blob/test-3.2.1/libraries/net/include/graphene/net/core_messages.hpp#L334-L339).
