When i started working in the dxperts-core one of the first problems i found after building a node was a proper way to run a node in the background.
...
You are now in a new terminal, navigate to your blockproducer, start the blockproducer by something like:

`programs/blockproducer_node/blockproducer_node --data-dir data/my-blockprod --genesis-json genesis/my-genesis.json --enable-stale-production -w \""1.6.0"\" \""1.6.1"\" \""1.6.2"\" \""1.6.3"\" \""1.6.4"\" --rpc-endpoint "localhost:8090"`
...
More cool stuff can be done with screen but these are the basics for using it with dxperts nodes.
...
```
root@alfredo:~/dxperts-munich/recurring/dxperts-core# screen -r
There are several suitable screens on:
        11873.pts-2.alfredo     (09/01/17 20:07:00)     (Detached)
        11831.pts-2.alfredo     (09/01/17 19:55:18)     (Detached)
Type "screen [-d] -r [pid.]tty.host" to resume one of them.
root@alfredo:~/dxperts-munich/recurring/dxperts-core#
```
