UPDATE(2019-07-25): please check the "requirements" table in [README](https://gitlab.com/dxperts/dxperts-core/blob/master/README.md#getting-started) for latest requirements to run the software.
