...
def main():
    ...
    for blockproducer in genesis["initial_blockproducer_candidates"]:
        owner_name = blockproducer["owner_name"]
        blockproducer["owner_name"] = name_map.get(owner_name, owner_name)
    for dxpcore in genesis["initial_dxpcore_candidates"]:
        owner_name = member["owner_name"]
        member["owner_name"] = name_map.get(owner_name, owner_name)
    for benefactor in genesis["initial_benefactor_candidates"]:
        owner_name = benefactor["owner_name"]
        benefactor["owner_name"] = name_map.get(owner_name, owner_name)
