...
def main():
    parser = argparse.ArgumentParser(description="Change initial_assets owned by the blockproducer-account to the dxpcore-account")
    ...
    for asset in genesis["initial_assets"]:
        if asset["issuer_name"] == "blockproducer-account":
            asset["issuer_name"] = "dxpcore-account"
