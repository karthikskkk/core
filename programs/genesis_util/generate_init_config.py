...
def main():
    ...
    parser.add_argument("-w", "--blockproducer", metavar="N", default=1, type=int, help="starting blockproducer ID")
    ...
    for i in range(opts.num):
        ...
        out_wits.append('blockproducer-id = "1.6.'+str(opts.blockproducer+i)+'"\n')
